...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("C:\\Workspace02\\mall200621\\gmall-parent\\gmall-parent\\service\\service-product\\src\\main\\java");
        globalConfig.setAuthor("LIANGBO");
        //生成后是否打开资源管理器
        ...
        strategy.setInclude("base_attr_value");
